...
CORETESTS_DIR = os.path.join(RUNTESTS_DIR, "..", "django_src", "tests")

TEMP_DIR = tempfile.mkdtemp(prefix='django_')
os.environ['DJANGO_TEST_TEMP_DIR'] = TEMP_DIR

sys.path.append(CORETESTS_DIR)
...
def setup(verbosity, test_labels):
    ...
    settings.TEMPLATE_DIRS = (os.path.join(RUNTESTS_DIR, TEST_TEMPLATE_DIR), os.path.join(CORETESTS_DIR, TEST_TEMPLATE_DIR),)
